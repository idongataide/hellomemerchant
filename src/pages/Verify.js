...
function Verify() {
    let email = localStorage.getItem('password_email')
  return (
    <div>
                            ...
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <div className="auth-form text-center">
                                        ...
                                        <p className='sub-text'>We just sent a verification e-mail to <span className='text-secondary'>{email}</span>. Kindly click the link in the mail to verify your Hellome Money account.</p>
                                        <form action="#">                                            
